...
public abstract class RestClient {
  ...
  //Converter.Factory converterFactory - отвечает за сериализацию/десериализацию объекта(class) в http и наоборот.
  //HttpLoggingInterceptor.Level loggingLevel - отвечает за уровень логирования
